...
AccountServiceArrayList accountServiceArrayList = new AccountServiceArrayList();
		...
		Account addAccount = new Account(1000, "BIM", 1000, 1.2);
		boolean isTrue= accountServiceArrayList.addAccount(addAccount);
		
		isTrue = accountServiceArrayList.addAccount(new Account(2222, "Park", 100000, 1.2));
