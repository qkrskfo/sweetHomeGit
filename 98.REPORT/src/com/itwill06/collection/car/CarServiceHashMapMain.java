...
public class CarServiceHashMapMain {
	...
	public static void main(String[] args) {
		...
		isSuccess = carService.ipCha(new Car("4566",4 ));
		isSuccess = carService.ipCha(new Car("4567",5 ));
		isSuccess = carService.ipCha(new Car("3321",6 ));
		isSuccess = carService.ipCha(new Car("3908",7 ));
		isSuccess = carService.ipCha(new Car("7891",8 ));
		isSuccess = carService.ipCha(new Car("3433",9 ));
