...
INSERT INTO member (m_id, m_password, m_name, m_address, m_age, m_married, m_regidate) VALUES ('bbbb', '2222', '박나래', '서울시 서초구', 31, 'F', sysdate);
INSERT INTO member (m_id, m_password, m_name, m_address, m_age, m_married, m_regidate) VALUES ('cccc', '3333', '박여름', '서울시 양천구', 5, 'F', sysdate);
